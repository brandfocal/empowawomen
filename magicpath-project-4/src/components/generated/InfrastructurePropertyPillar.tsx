...
const CoreSegmentsSection: React.FC = () => {
  ...
  return <section className="segments-light-section w-full py-12 px-5 sm:py-16 sm:px-8 lg:py-24 lg:px-16 xl:py-28" style={{
...
const ROIParametersSection: React.FC = () => {
  return <section className="w-full py-12 px-5 sm:py-16 sm:px-8 lg:py-24 lg:px-16 xl:py-28" style={{
    ...
    borderBottom: "1px solid rgba(255,255,255,0.05)"
      ...
      margin: "0 auto"
        ...
        duration: 0.7,
        delay: 0.4
      }} className="flex flex-col sm:flex-row gap-6 lg:gap-10 items-start mt-8 lg:mt-14">
          <div style={{
          display: "flex",
          gap: "20px",
          alignItems: "flex-start",
...
const CTASection: React.FC = () => {
  return <section className="py-20 px-5 sm:py-24 sm:px-8 lg:py-32 lg:px-16 xl:py-40" style={{
    position: "relative",
    overflow: "hidden",
    backgroundColor: "#0A0A0F"
  }}>
