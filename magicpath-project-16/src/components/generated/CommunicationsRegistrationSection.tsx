...
export const CommunicationsRegistrationSection: React.FC = () => {
        ...
        width: "100%"
          ...
          gap: "16px"
            ...
            gap: "12px"
                ...
                <input type="checkbox" id="reg-agree-camm" checked={form.agreed} onChange={e => handleChange("agreed", e.target.checked)} required style={{
              accentColor: "#FF2D87",
              marginTop: "2px",
              flexShrink: 0,
              width: "16px",
              ...
              cursor: "pointer"
                ...
                <label htmlFor="reg-agree-camm" style={{
              fontFamily: "Figtree, sans-serif",
              color: "rgba(255,255,255,0.45)",
              fontSize: "12px",
              lineHeight: 1.6,
