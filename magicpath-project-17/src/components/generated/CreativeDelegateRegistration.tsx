...
const INDUSTRY_OPTIONS = [{
  ...
  id: "ind-2",
  label: "Broadcasting & Radio"
}, {
  id: "ind-3",
  label: "Digital Media & Streaming"
}, {
  id: "ind-4",
  label: "Creative Entrepreneurship"
}, {
  id: "ind-5",
  ...
  id: "ind-7",
  label: "Gaming & Animation"
}, {
  id: "ind-8",
  label: "Publishing & Storytelling"
}, {
  id: "ind-9",
...
const DETAILS_ROWS = [{
  id: "dr-1",
  label: "Stage",
  value: "Creative Economy, Film, Media & Entertainment™"
}, {
  id: "dr-2",
  label: "Date",
...
const INCLUDES = [{
  id: "inc-1",
  text: "Full-day Creative Economy Stage access"
}, {
  id: "inc-2",
  text: "Premium executive programme (9 sessions)"
}, {
  id: "inc-3",
  text: "High-impact networking & creative matchmaking"
}, {
  id: "inc-4",
...
export const CreativeDelegateRegistration: React.FC = () => {
      ...
      alignItems: "start"
        ...
        width: "100%"
          ...
          margin: "0 0 12px 0"
            ...
            Secure Your Place at Africa&apos;s Creative Economy Stage™
          </h2>
          <p style={{
          fontFamily: "Figtree, sans-serif",
          ...
          paddingBottom: "64px"
            ...
            margin: 0
                ...
                Thank you for registering for the Creative Economy, Film, Media &amp; Entertainment Stage™. Our team will confirm your delegate place within 24 hours. Please check your inbox.
              </p>
              <div style={{
            display: "flex",
            gap: "12px",
            ...
            textAlign: "center"
                ...
                #CreativeEconomy · #EmpowaWomen · #WomenInMedia
              </p>
          ...
          gap: "16px"
              ...
              <div className="creg-name-row" style={{
            display: "flex",
            gap: "16px",
            flexDirection: "column"
          }}>
              ...
              <div className="creg-company-row" style={{
            display: "flex",
            gap: "16px",
            flexDirection: "column"
          }}>
            ...
            gap: "12px"
                ...
                <input type="checkbox" id="creg-agree" checked={form.agreed} onChange={e => handleChange("agreed", e.target.checked)} required style={{
              accentColor: "#FF2D87",
              marginTop: "2px",
              flexShrink: 0,
              width: "16px",
              ...
              cursor: "pointer"
                ...
                <label htmlFor="creg-agree" style={{
              fontFamily: "Figtree, sans-serif",
              color: "rgba(255,255,255,0.45)",
              fontSize: "12px",
              lineHeight: 1.6,
        ...
        <div className="creg-card-col" style={{
        width: "100%",
        flexShrink: 0
      }}>
          <div style={{
          ...
          overflow: "hidden"
            ...
            <div style={{
            height: "180px",
            backgroundImage: "url('https://empowawomen.co.za/wp-content/uploads/2025/10/DSC_2683.jpg')",
