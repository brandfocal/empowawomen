...
import { Film, Tv2, Radio, Wifi, Star, BookOpen, Gamepad2, Cpu, Check, ArrowRight, Clock, CheckCircle2 } from "lucide-react";
import { CreativeMainNavBar } from "./CreativeMainNavBar";
import { CreativeHeroBanner } from "./CreativeHeroBanner";
import { CreativeROIMetricBlock } from "./CreativeROIMetricBlock";
import { CreativeDelegateRegistration } from "./CreativeDelegateRegistration";
import { CreativeGlobalFooter } from "./CreativeGlobalFooter";
...
const PROGRAMME_SESSIONS: ProgrammeSession[] = [{
  ...
  subtitle: "The Future Will Belong to Those Who Own the Story, The Audience, The Platform and The Intellectual Property.",
  accentColor: "#FF2D87",
  ...
  subtitle: "How AI, streaming platforms, and digital innovation are transforming film, television, content creation, and audience monetisation.",
  accentColor: "#D4AF37",
  ...
  subtitle: "How women can commercialise creativity, scale creative enterprises, and build sustainable media brands.",
  accentColor: "#00B4A6",
  accentRgb: "0,180,166"
}, {
  id: "ps-4",
  ...
  subtitle: "Strategic partnerships, content collaborations, and investment conversations.",
  accentColor: "#00B4A6",
  accentRgb: "0,180,166",
  isLunch: true
}, {
  ...
  subtitle: "How women-led creative businesses can unlock new revenue streams and access international markets.",
  accentColor: "#FF2D87",
  accentRgb: "255,45,135"
}, {
  id: "ps-6",
  ...
  subtitle: "How women can build, protect, and monetise creative assets.",
  accentColor: "#00B4A6",
  accentRgb: "0,180,166"
}, {
  id: "ps-7",
  ...
  subtitle: "Africa's Greatest Export May Be Its Stories.",
  accentColor: "#D4AF37",
  accentRgb: "212,175,55"
}, {
  id: "ps-8",
  ...
  subtitle: "The Next Generation of Economic Power Will Be Built Through Creativity, Technology and Influence.",
  accentColor: "#FF2D87",
  accentRgb: "255,45,135"
}, {
  id: "ps-9",
  ...
  subtitle: "The Future Belongs to Women Who Transform Creativity Into Economic Power.",
  accentColor: "#00B4A6",
  accentRgb: "0,180,166"
}];
  ...
  return <div style={{
    ...
    fontFamily: "Figtree, sans-serif"
      ...
      <main>
        ...
        {/* ── 2. Stage Overview Section — dark, two-column ── */}
        ...
        margin: "0 auto"
          ...
          <div className="creative-overview-grid">
            ...
            {/* Right: editorial image + 3 mini stats */}
            <motion.div initial={{
            opacity: 0,
            x: 30
          }} animate={overviewInView ? {
            ...
            gap: "0"
              ...
              marginTop: "8px"
                ...
                {MINI_STATS.map(s => <div key={s.label} style={{
                paddingLeft: "16px",
        ...
        margin: "0 auto"
          ...
          <div className="creative-roi-benefits-grid">
            ...
            gap: "0"
              ...
              const accent = idx % 3 === 0 ? "#FF2D87" : idx % 3 === 1 ? "#00B4A6" : "#D4AF37";
              return <motion.div key={attendee.id} initial={{
                opacity: 0,
                x: 16
              }} animate={roiInView ? {
                opacity: 1,
        ...
        paddingRight: "clamp(16px, 5vw, 96px)"
          ...
          gap: "clamp(24px, 3vw, 32px)"
            ...
            <div className="creative-cta-btn-group">
              <button className="creative-cta-btn-primary" style={{
              backgroundColor: "#FF2D87",
              color: "#FFFFFF",
              fontFamily: "Figtree",
              ...
              <button className="creative-cta-btn-secondary" style={{
      ...
      <CreativeDelegateRegistration />

      {/* ── 9. Global Footer ── */}
      <CreativeGlobalFooter />
