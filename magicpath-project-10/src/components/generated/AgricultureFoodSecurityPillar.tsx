...
import { Leaf, Sprout, Truck, Globe, Building2, Coins, Cpu, ArrowRight, Wheat, Tractor, ShoppingBag, Target } from "lucide-react";
      ...
      textAlign: "center"
        ...
        ease: [0.21, 0.47, 0.32, 0.98]
          ...
          width: "100%"
            ...
            <a href="#registration" className="w-full sm:w-auto" style={{
            fontFamily: "Figtree",
            fontSize: "15px",
            fontWeight: 500,
            color: "#FFFFFF",
            ...
            <a href="#focus-areas" className="w-full sm:w-auto" style={{
            fontFamily: "Figtree",
            fontSize: "15px",
            fontWeight: 400,
            color: "#FFFFFF",
...
export const AgricultureFoodSecurityPillar: React.FC = () => {
      ...
      <main>
        ...
        textAlign: "center"
          ...
          width: "100%"
            ...
            <SectionLabel>Take the Lead</SectionLabel>
            <h2 style={{
            fontFamily: "Figtree",
            fontWeight: 300,
