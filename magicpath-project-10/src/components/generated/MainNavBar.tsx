    ...
    zIndex: 100
      ...
      position: "relative"
        ...
        marginLeft: "auto"
          ...
          {/* CTA pill — hidden on mobile, shown sm+ */}
          ...
          <button className="lg:hidden" onClick={() => setIsMenuOpen(!isMenuOpen)} aria-label="Toggle menu" aria-expanded={isMenuOpen} style={{
          background: "none",
          border: "none",
          cursor: "pointer",
          color: "#FFFFFF",
      ...
      <AnimatePresence>
        {isMenuOpen && <motion.nav aria-label="Mobile navigation" initial={{
        opacity: 0,
        y: -10
      }} animate={{
        opacity: 1,
        ...
        gap: "0"
            ...
            {NAV_LINKS.map(link => <a key={link.id} href={link.href} onClick={() => setIsMenuOpen(false)} style={{
          fontFamily: "Figtree",
          fontSize: "16px",
          ...
          justifyContent: "space-between"
            ...
            <a href="#" onClick={() => setIsMenuOpen(false)} style={{
          fontFamily: "Figtree",
          fontSize: "14px",
          fontWeight: 500,
          color: "#FFFFFF",
