  ...
  return <footer id="contact" style={{
    ...
    boxSizing: "border-box"
      ...
      gap: "0"
        ...
        maxWidth: "100%"
          ...
          gap: "24px"
            ...
            margin: 0
              ...
              Summit invitations, leadership insights, and curated opportunities for
              Africa's most ambitious women — delivered directly to you.
            </motion.p>
          </div>

          {/* Email input + subscribe — wraps on very small screens */}
          <motion.div initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          ...
          duration: 0.6,
          delay: 1.0
        }} className="newsletter-form" style={{
          display: "flex",
          flexWrap: "nowrap",
          gap: "0",
          alignItems: "center",
        ...
        {/* Footer nav grid: 1 col mobile, 2 col sm+, 3 col lg+ */}
        <section style={{
        width: "100%",
        marginTop: "clamp(40px, 6vw, 64px)"
          ...
          {/* Bottom bar: stacks vertically on mobile, horizontal on md+ */}
          <div style={{
          marginTop: "48px",
          paddingTop: "32px",
      ...
      <style>{`
        ...
        /* Bottom bar: stacks on mobile, row on md+ */
        .footer-bottom-bar {
          display: flex;
        ...
        /* Newsletter form: column on very small screens */
