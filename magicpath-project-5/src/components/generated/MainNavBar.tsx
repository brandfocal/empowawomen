...
const LOGO_IMG_SRC = "/src/assets/magicpath/context/02-context-image-2-5e4b5ab63ff5.jpg";
const LogoMark: React.FC = () => <div style={{
  width: "32px",
  height: "32px",
  ...
  overflow: "hidden"
    ...
    <img src={LOGO_IMG_SRC} alt="EmpowaWomen logo mark" style={{
    width: "100%",
    height: "100%",
    objectFit: "cover"
  }} onError={e => {
      ...
      position: "relative"
        ...
        gap: "0px"
          ...
          {NAV_LINKS.map((link, idx) => <React.Fragment key={link.id}>
            ...
            color: hoveredLink === link.id ? "rgba(255,255,255,0.80)" : link.isActive ? "rgba(255,255,255,0.70)" : "rgba(255,255,255,0.40)",
            textDecoration: "none",
            padding: "6px 12px",
