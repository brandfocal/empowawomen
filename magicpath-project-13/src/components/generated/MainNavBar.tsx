    ...
    zIndex: 100
      ...
      position: "relative"
        ...
        marginLeft: "auto"
          ...
          {/* CTA pill — hidden on mobile, visible on sm+ */}
          <a href="#" className="nav-cta-pill" style={{
          fontFamily: "Figtree",
          fontSize: "12px",
          fontWeight: 500,
          color: "#FFFFFF",
          ...
          <button className="nav-hamburger" onClick={() => setMobileOpen(!mobileOpen)} aria-label="Toggle menu" aria-expanded={mobileOpen} style={{
          background: "none",
          border: "none",
          cursor: "pointer",
          color: "#FFFFFF",
      ...
      <style>{`
        ...
        /* Desktop: show nav links and CTA pill, hide hamburger */
        @media (min-width: 1024px) {
          .nav-desktop { display: flex !important; }
          .nav-cta-pill { display: inline-flex !important; }
          .nav-hamburger { display: none !important; }
        }
        /* Mobile/Tablet: hide nav links and CTA pill, show hamburger */
