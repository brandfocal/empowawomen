...
const INDUSTRY_OPTIONS = [{
  ...
  id: "ind-6",
  label: "FMCG & Food Manufacturing"
}, {
  id: "ind-7",
  label: "Textile & Fashion Manufacturing"
}, {
  id: "ind-8",
...
const DETAILS_ROWS = [{
  id: "dr-1",
  label: "Stage",
  value: "Wholesale, Retail & Manufacturing™"
}, {
  id: "dr-2",
  label: "Date",
...
const INCLUDES = [{
  id: "inc-1",
  text: "Full-day Wholesale, Retail & Manufacturing Stage access"
}, {
  id: "inc-2",
  text: "Premium executive programme (9 sessions)"
}, {
  id: "inc-3",
  text: "Industrial networking & procurement matchmaking"
}, {
  id: "inc-4",
...
export const WholesaleRegistrationSection: React.FC = () => {
  ...
  return <motion.section initial={{
    ...
    paddingRight: "clamp(16px, 5vw, 32px)"
      ...
      {/* Inner */}
      <div className="wrm-reg-layout" style={{
      position: "relative",
      zIndex: 1,
      maxWidth: "1024px",
      margin: "0 auto",
      ...
      alignItems: "start"
        ...
        width: "100%"
          ...
          gap: "16px"
              ...
              <div className="wrm-name-row" style={{
            display: "flex",
            gap: "16px",
            flexDirection: "column"
          }}>
              ...
              <div className="wrm-company-row" style={{
            display: "flex",
            gap: "16px",
            flexDirection: "column"
          }}>
            ...
            color: form.hearAboutUs ? "#FFFFFF" : "rgba(255,255,255,0.25)"
              ...
              <textarea rows={3} placeholder="Any special requirements, dietary needs, or questions?" value={form.specialRequirements} onChange={e => handleChange("specialRequirements", e.target.value)} onFocus={() => setFocused("specialRequirements")} onBlur={() => setFocused(null)} style={{
            ...
            gap: "12px"
                ...
                <input type="checkbox" id="wrm-reg-agree" checked={form.agreed} onChange={e => handleChange("agreed", e.target.checked)} required style={{
              accentColor: "#FF2D87",
              marginTop: "2px",
              flexShrink: 0,
              width: "16px",
              ...
              cursor: "pointer"
                ...
                <label htmlFor="wrm-reg-agree" style={{
              fontFamily: "Figtree, sans-serif",
              color: "rgba(255,255,255,0.45)",
              fontSize: "12px",
              lineHeight: 1.6,
        ...
        <div className="wrm-reg-card-col" style={{
        width: "100%",
        flexShrink: 0
      }}>
          <div style={{
