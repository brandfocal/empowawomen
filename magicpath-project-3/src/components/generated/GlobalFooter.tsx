...
export const GlobalFooter: React.FC = () => {
  ...
  return <footer id="contact" style={{
    ...
    borderTop: "1px solid rgba(255,255,255,0.06)"
        ...
        maxWidth: "100%"
          ...
          gap: "24px"
            ...
            margin: 0
              ...
              Summit invitations, leadership insights, and curated opportunities for Africa's most ambitious women —
              delivered directly to you.
            </motion.p>
          </div>

          {/* Email input + subscribe — full width on mobile */}
          <motion.div initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
      ...
      <style>{`
        /* Mobile: stack footer section rows vertically */
        ...
        /* Mobile: constrain newsletter form */
