...
const ATTENDEE_LIST = [
  { id: "at-1", label: "Property Developers & Real Estate Investors" },
  { id: "at-2", label: "Infrastructure Engineers & Contractors" },
  { id: "at-3", label: "Transport & Logistics Executives" },
  { id: "at-4", label: "Urban Planners & Smart City Designers" },
  { id: "at-5", label: "DFI Funders & Infrastructure Financiers" },
  { id: "at-6", label: "Procurement Officials & Public Sector Leaders" }
];
