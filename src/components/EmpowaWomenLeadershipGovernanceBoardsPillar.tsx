        ...
        <div style={{ flex: 1, minWidth: 0, width: "100%" }}>
          ...
          {submitted ? (
            ...
            >
              ...
              >
                Thank you for registering for the Leadership, Governance &amp; Boards Stage™. Our team will confirm your delegate
                place within 24 hours. Please check your inbox.
              </p>
              <p
                style={{
                  fontFamily: "Figtree, sans-serif",
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
                ...
                />
                <label htmlFor="reg-agree" style={{ fontFamily: "Figtree, sans-serif", color: "rgba(255,255,255,0.45)", fontSize: "12px", lineHeight: 1.6, cursor: "pointer" }}>
                  I agree to the EmpowaWomen™ Privacy Policy and Terms &amp; Conditions. I consent to receiving summit-related
                  communications.
                </label>
              </div>

              {/* Submit: Standardized Pill-shaped */}
              <button
                type="submit"
                style={{
                  width: "100%",
