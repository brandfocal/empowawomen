...
const INDUSTRY_OPTIONS = [
  { id: "ind-1", label: "Wholesale & Distribution" },
  { id: "ind-2", label: "Retail & Consumer Goods" },
  { id: "ind-3", label: "Manufacturing & Production" },
  { id: "ind-4", label: "E-Commerce & Digital Retail" },
  { id: "ind-5", label: "Logistics & Supply Chain" },
  { id: "ind-6", label: "FMCG & Food Manufacturing" },
  { id: "ind-7", label: "Textile & Fashion Manufacturing" },
  { id: "ind-8", label: "Industrial & Engineering" },
  { id: "ind-9", label: "Export & International Trade" },
  { id: "ind-10", label: "Investment & Finance" },
  { id: "ind-11", label: "Government & Policy" },
  { id: "ind-12", label: "Academia & Research" },
  { id: "ind-13", label: "Other" }
];
...
const DETAILS_ROWS = [
  { id: "dr-1", label: "Stage", value: "Wholesale, Retail & Manufacturing™" },
...
const INCLUDES = [
  { id: "inc-1", text: "Full-day Wholesale, Retail & Manufacturing Stage access" },
  { id: "inc-2", text: "Premium executive programme (9 sessions)" },
  { id: "inc-3", text: "Industrial networking & procurement matchmaking" },
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0, width: "100%" }}>
          ...
          >
            Secure Your Place at Africa's Wholesale, Retail &amp; Manufacturing Stage™
          </h2>
          <p
            style={{
              fontFamily: "Figtree, sans-serif",
          ...
          >
            Investment: R1,500 per delegate. Complete the form below and our team will confirm your
          ...
          {submitted ? (
            ...
            >
              ...
              >
                Thank you for registering for the Wholesale, Retail &amp; Manufacturing Stage™. Our
              ...
              >
                #IndustrialLeaders · #EmpowaWomen · #WomenInManufacturing
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%" }}>
              {/* Row 1: First Name | Last Name */}
              <div className="wrm-name-row" style={{ display: "flex", gap: "16px", flexDirection: "column" }}>
                <input
                  type="text"
              ...
              <div className="wrm-company-row" style={{ display: "flex", gap: "16px", flexDirection: "column" }}>
                <input
                  type="text"
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
                ...
                >
                  I agree to the EmpowaWomen™ Privacy Policy and Terms &amp; Conditions. I consent
                  to receiving summit-related communications.
                </label>
              </div>
              ...
              <button
                ...
                onMouseLeave={e => {
                  e.currentTarget.style.backgroundColor = "#FF2D87";
                }}
              >
                Submit Registration →
              </button>
        ...
        <div className="wrm-reg-card-col" style={{ width: "100%", flexShrink: 0 }}>
          <div
            style={{
          ...
          >
            {/* Top image strip: Updated to standard DSC_2948.jpg */}
            <div
              style={{
                height: "180px",
      ...
      <style>{`
        /* Desktop: side-by-side, sticky card */
        ...
        /* Mobile: card not sticky, full width */
