...
const ATTENDEE_LIST = [
  { id: "at-1", label: "Beauty Brand Founders & Retailers" },
  { id: "at-2", label: "Fashion Designers & Luxury Curators" },
  { id: "at-3", label: "Healthcare Executives & Preventative Care Directors" },
  { id: "at-4", label: "Wellness Practitioners & Holistic Coaches" },
  { id: "at-5", label: "Consumer Goods Investors & Fund Managers" },
  { id: "at-6", label: "Content Creators & Digital Influencers" }
];
  ...
  return (
    <DelegateRegistrationSection
      ...
      includes={[
        ...
        "High-impact networking & brand matchmaking",
