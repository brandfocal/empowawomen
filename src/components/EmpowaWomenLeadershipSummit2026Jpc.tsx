...
export const EmpowaWomenLeadershipSummit2026Jpc: React.FC = () => {
                ...
                <div style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                        ...
                        <img 
                            ...
                            onError={(e) => {
                                // Fallback just in case JPC logo does not exist in the public directory yet
                    ...
                    >
                        <div style={{
                            ...
                            <img 
                                ...
                                alt="EmpowaWomen Leadership Summit 2026 - JPC" 
