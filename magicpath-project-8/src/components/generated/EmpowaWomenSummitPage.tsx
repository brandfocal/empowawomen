...
import { ArrowRight, Check, Menu, X, Linkedin, Twitter, Instagram, Facebook, Shield } from "lucide-react";
...
const FOOTER_NAV_COLS: FooterNavCol[] = [{
  id: "fnc-pages",
  label: "Pages",
  links: [{
    id: "fp-1",
...
function getAvatarBg(index: number): string {
  return AVATAR_BG_CYCLE[index % 3];
}
  ...
  return <div className="fixed top-0 left-0 right-0 z-[100]">
      ...
      paddingRight: "clamp(16px, 5vw, 80px)"
        ...
        <div className="flex items-center shrink-0 ml-auto md:ml-0">
          ...
          <a href="#" className="hidden md:inline-flex items-center overflow-hidden no-underline" style={{
          fontFamily: "Figtree",
          fontSize: "12px",
          fontWeight: 500,
          color: "#FFFFFF",
          ...
          <button className="md:hidden text-white p-2 ml-2" onClick={() => setIsMenuOpen(!isMenuOpen)} aria-label="Toggle menu">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32 flex flex-col lg:flex-row items-start lg:items-center gap-12 lg:gap-24">
        ...
        ease: "easeOut"
          ...
          (e.currentTarget as HTMLAnchorElement).style.opacity = "1";
            ...
            <span>Secure Your Delegate Seat</span>
            <ArrowRight size={14} />
          </a>
        </motion.div>
      ...
      zIndex: 1
        ...
        ease: "easeOut"
          ...
          margin: 0
            ...
            Saturday, 28 August 2026 · 08h00 – 16h00 · The Forum, The Campus, Bryanston
          </p>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-12">
          ...
          ease: "easeOut"
            ...
            <motion.div ref={cardRef} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} style={{
            rotateX,
            rotateY,
...
// ─── Cinematic Strip ──────────────────────────────────────────────────────────
const CinematicStrip: React.FC = () => {
  return <div style={{
    width: "100%",
    position: "relative",
    overflow: "hidden"
  }} className="h-[180px] sm:h-[240px] md:h-[280px]">
      <img src="https://empowawomen.co.za/wp-content/uploads/2025/10/DSC_2778.jpg" alt="EmpowaWomen event" style={{
      width: "100%",
      height: "100%",
      objectFit: "cover",
      ...
      position: "absolute",
      inset: 0,
      background: "linear-gradient(to right, rgba(10,10,15,0.60) 0%, transparent 40%, transparent 60%, rgba(10,10,15,0.60) 100%)",
      zIndex: 1
    }} />
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32 flex flex-col items-center text-center">
        ...
        ease: "easeOut"
          ...
          margin: "0 0 20px 0"
            ...
            365 Days. Countless Opportunities.
          </h2>
          <p style={{
          fontFamily: "Figtree",
          fontSize: "clamp(14px, 1.8vw, 17px)",
  ...
  return <section className="px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32" style={{
    ...
    position: "relative"
      ...
      <div className="max-w-5xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16">
        ...
        {/* RIGHT — Summary card: static (not sticky) on all screens */}
        <motion.div initial={{
        opacity: 0,
        x: 24
      }} whileInView={{
...
const FooterSection: React.FC<{
  ...
  return <footer id="contact" ref={footerRef as React.RefObject<HTMLElement>} className="relative w-full flex flex-col items-center overflow-hidden px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 pb-8 sm:pb-12" style={{
    backgroundColor: "#0A0A0F",
    color: "#FFFFFF"
  }}>
      ...
      zIndex: 1
        ...
        <section className="flex flex-col gap-6 sm:gap-8 max-w-full">
          <div className="flex flex-col gap-4 sm:gap-5">
            ...
            <div className="max-w-[720px]">
              ...
              margin: 0
                ...
                display: "inline-block",
                marginRight: "0.2em",
                color: word === "moves" ? ACCENT_TEAL : "#FFFFFF"
              }}>
                    {word}
                  </motion.span>)}
              </h2>
        ...
        {/* Footer nav: 1-col mobile, 3-col on md+ */}
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10 mt-12 sm:mt-16 mb-10 sm:mb-14">
          {FOOTER_NAV_COLS.map(col => <div key={col.id} className="flex flex-col gap-4">
              <span style={{
            fontFamily: "Figtree",
            fontSize: "11px",
            fontWeight: 600,
            ...
            textTransform: "uppercase"
              ...
              <div className="flex flex-col gap-3">
                {col.links.map(link => <a key={link.id} href={link.href} className="no-underline whitespace-nowrap transition-colors duration-200" style={{
              fontFamily: "Figtree",
              fontSize: "14px",
              fontWeight: 400,
              color: "rgba(255,255,255,0.45)"
        ...
        {/* Bottom bar: vertical on mobile, horizontal on sm+ */}
        <div className="pt-6 sm:pt-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 w-full" style={{
        borderTop: "1px solid rgba(255,255,255,0.06)"
      }}>
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
            ...
            color: "rgba(255,255,255,0.20)"
              ...
              © 2026 EmpowaWomen. All rights reserved.
            </span>
          </div>
        ...
        <div className="mt-6 flex flex-col items-center gap-3">
          ...
          <p className="mb-0 text-center italic" style={{
          fontFamily: "Figtree",
          fontWeight: 300,
          fontSize: "14px",
          margin: 0
...
export const EmpowaWomenSummitPage: React.FC = () => {
  ...
  return <main className="selection:bg-[#FF2D87]/30" style={{
    ...
    fontFamily: "Figtree"
      ...
      <FooterSection footerRef={footerRef} scrollToRegistration={scrollToRegistration} />
