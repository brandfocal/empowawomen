...
const DETAILS_ROWS = [{
  id: "dr-1",
  label: "Stage",
  value: "Green Economy, Mining, Energy & Sustainability™"
}, {
  id: "dr-2",
  label: "Date",
...
const INCLUDES = [{
  id: "inc-1",
  text: "Full-day Green Economy Stage access"
}, {
  id: "inc-2",
  text: "Premium executive programme (9 sessions)"
}, {
  id: "inc-3",
  text: "High-impact networking & matchmaking"
}, {
  id: "inc-4",
